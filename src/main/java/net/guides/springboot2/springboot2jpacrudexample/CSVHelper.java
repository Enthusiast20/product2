...
import net.guides.springboot2.springboot2jpacrudexample.exception.InvalidCSVFileException;
	...
	public void loadCsvData()
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				if("color".equalsIgnoreCase(productProperties.split(":")[0]))
					{
						pc.setColor(productProperties.split(":")[1]);
					}
				if("gb_limit".equalsIgnoreCase(productProperties.split(":")[0]))
				{
